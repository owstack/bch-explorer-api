...
var bcccore = {
  ...
  datadir: bcccoreDataDir,
  exec: 'bcccored', // ensure this on your path or add the full, absolute path.
  args: ['start'],
  process: null
};
...
var startFakeNode = function() {
  server = net.createServer(function(socket) {
    ...
    socket.on('end', function() {
      console.log('bcccore-node has ended the connection');
    });
...
describe('Reorg', function() {
  // 1. spin up bcccore-node and have it connect to our custom tcp socket
